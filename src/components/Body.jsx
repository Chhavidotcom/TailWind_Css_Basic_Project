...
const Body = () => {
  return (
    ...
    <div className='space-y-4 lg:flex-1 lg:order-1 lg:space-y-10'>
      ...
      <p className='font-lato text-green-950'>With Hosterr, get your website up and running in no less than 5 minutes with the most competitive pricing packages available online.</p>
      ...
      <div className='flex gap-2'>
        ...
        <p className='font-lato text-blue-950'>No spam, ever. Unsubscribe anytime.</p>
      </div>
    </div>
    </div>
  )
